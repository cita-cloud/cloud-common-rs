...
impl Regions {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            ...
            Self::Proof => "PROOF",
            Self::Result => "RESULT",
            Self::TransactionHash2blockHeight => "TRANSACTION_HASH2BLOCK_HEIGHT",
            Self::BlockHash2blockHeight => "BLOCK_HASH2BLOCK_HEIGHT",
            Self::TransactionIndex => "TRANSACTION_INDEX",
            Self::CompactBlock => "COMPACT_BLOCK",
            Self::FullBlock => "FULL_BLOCK",
            Self::AllBlockData => "All_BLOCK_DATA",
            Self::TransactionsPool => "TRANSACTIONS_POOL",
            Self::Button => "BUTTON",
        }
    }
