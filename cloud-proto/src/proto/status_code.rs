...
impl StatusCodeEnum {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            ...
            Self::ConvertIntError => "ConvertIntError",
            Self::NoneStatusCode => "NoneStatusCode",
            Self::FatalError => "FatalError",
            Self::MisbehaveNode => "MisbehaveNode",
            Self::BannedNode => "BannedNode",
            Self::AddressOriginCheckError => "AddressOriginCheckError",
            Self::ProvideAddressError => "ProvideAddressError",
            Self::NoProvideAddress => "NoProvideAddress",
            Self::NoBlock => "NoBlock",
            Self::NoProof => "NoProof",
            Self::NoTxHeight => "NoTxHeight",
            Self::NoTxIndex => "NoTxIndex",
            Self::NoTransaction => "NoTransaction",
            Self::NoBlockHeight => "NoBlockHeight",
            Self::NoBlockHash => "NoBlockHash",
            Self::NoneProposal => "NoneProposal",
            Self::NoneBlockBody => "NoneBlockBody",
            Self::NoneBlockHeader => "NoneBlockHeader",
            Self::NoneChainStatus => "NoneChainStatus",
            Self::NoneWitness => "NoneWitness",
            Self::NoneTransaction => "NoneTransaction",
            Self::NoneUtxo => "NoneUtxo",
            Self::NoneRawTx => "NoneRawTx",
            Self::EarlyStatus => "EarlyStatus",
            Self::ExecuteError => "ExecuteError",
            Self::EncodeError => "EncodeError",
            Self::DecodeError => "DecodeError",
            Self::NoCandidate => "NoCandidate",
            Self::NoEarlyStatus => "NoEarlyStatus",
            Self::NoForkTree => "NoForkTree",
            Self::DupTransaction => "DupTransaction",
            Self::ProposalTooHigh => "ProposalTooHigh",
            Self::ProposalTooLow => "ProposalTooLow",
            Self::ProposalCheckError => "ProposalCheckError",
            Self::ConsensusProposalCheckError => "ConsensusProposalCheckError",
            Self::BlockCheckError => "BlockCheckError",
            Self::CsiSigCheckError => "CSISigCheckError",
            Self::VersionOrIdCheckError => "VersionOrIdCheckError",
            Self::HashCheckError => "HashCheckError",
            Self::HashLenError => "HashLenError",
            Self::SigLenError => "SigLenError",
            Self::SigCheckError => "SigCheckError",
            Self::NodeInSyncMode => "NodeInSyncMode",
            Self::HistoryDupTx => "HistoryDupTx",
            Self::EmergencyBrake => "EmergencyBrake",
            Self::InvalidVersion => "InvalidVersion",
            Self::InvalidTo => "InvalidTo",
            Self::InvalidNonce => "InvalidNonce",
            Self::InvalidValidUntilBlock => "InvalidValidUntilBlock",
            Self::InvalidValue => "InvalidValue",
            Self::InvalidChainId => "InvalidChainId",
            Self::InvalidWitness => "InvalidWitness",
            Self::InvalidLockId => "InvalidLockId",
            Self::InvalidPreHash => "InvalidPreHash",
            Self::AdminCheckError => "AdminCheckError",
            Self::ModuleNotController => "ModuleNotController",
            Self::QuotaUsedExceed => "QuotaUsedExceed",
            Self::NoStateRoot => "NoStateRoot",
            Self::StateRootCheckError => "StateRootCheckError",
            Self::UpdateSystemConfigError => "UpdateSystemConfigError",
            Self::NoReceiptProof => "NoReceiptProof",
            Self::ConsensusServerNotReady => "ConsensusServerNotReady",
            Self::ProposalProofError => "ProposalProofError",
            Self::CryptoServerNotReady => "CryptoServerNotReady",
            Self::NoneHashResult => "NoneHashResult",
            Self::ConstructSigError => "ConstructSigError",
            Self::ConstructKeyPairError => "ConstructKeyPairError",
            Self::SignError => "SignError",
            Self::NetworkServerNotReady => "NetworkServerNotReady",
            Self::SendMsgError => "SendMsgError",
            Self::BroadcastMsgError => "BroadcastMsgError",
            Self::MultiAddrParseError => "MultiAddrParseError",
            Self::DialNodeFail => "DialNodeFail",
            Self::AddExistedPeer => "AddExistedPeer",
            Self::ExecuteServerNotReady => "ExecuteServerNotReady",
            Self::InternalChannelDisconnected => "InternalChannelDisconnected",
            Self::ReenterBlock => "ReenterBlock",
            Self::ReenterInvalidBlock => "ReenterInvalidBlock",
            Self::StorageServerNotReady => "StorageServerNotReady",
            Self::NotFound => "NotFound",
            Self::InvalidRegion => "InvalidRegion",
            Self::InvalidKey => "InvalidKey",
            Self::BadRegion => "BadRegion",
